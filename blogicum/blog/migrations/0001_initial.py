# Generated by Django 3.2.16 on 2024-08-14 09:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(auto_now_add=True, help_text='Если установить дату и время в будущем — можно делать отложенные публикации.', unique=True, verbose_name='Дата и время публикации')),
